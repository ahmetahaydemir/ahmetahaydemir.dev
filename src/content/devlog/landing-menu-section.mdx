...
Now that the gameplay loop is documented, I will be focusing the sections defined in there one by one in isolation to get them to their **MVP** stage. This section is not the most critical one; but it is the first scene the visitors will see.
