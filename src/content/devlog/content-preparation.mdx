...
Now that I have the basic data structure and some analytics tools in my hands, it is time to actually place the content in the project.
...
One of the benefits of doing this game development thing for a long time is that you start having assets/templates that you use in every project.
...
What started this project in my mind was [Super Auto Pets](https://store.steampowered.com/app/1714040/Super_Auto_Pets/) and [Slay the Spire](https://store.steampowered.com/app/646570/Slay_the_Spire/). So I knew that I needed lots of animal model variety in the project to do what I want.
...
I have some ideas on what to do with `music` tracks. I know a lot of cool indie artists from working together in game jams before who can handle that part. But the `SFX` part is kind of tricky.
...
- https://ahmetahaydemir.dev/wild-chess-simulator/api/getZoneData.json
...
Then the manual parsing procedure starts in Unity according to the data structure I declared in here and serialized data is stored in [scriptable objects](https://docs.unity3d.com/2023.2/Documentation/Manual/class-ScriptableObject.html) and [text assets](https://docs.unity3d.com/2023.2/Documentation/ScriptReference/TextAsset.html) under a specific folder.
...
Here is how that automatically generated folder looks in Unity.

![Database folder in Unity](/image/DatabaseFolder.png "Database folder in Unity")